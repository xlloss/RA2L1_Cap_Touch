...
/* Actual period: 0.005 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xea60,
  .duty_cycle_counts = 0x7530, .source_div = (timer_source_div_t) 1, .channel = 0, .p_callback = timer0_callback,
